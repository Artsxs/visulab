...
export const RESPONSE_SCHEMA = object({
  ...
  cenas: { type: 'array', minItems: 1, maxItems: 6, items: object({ cenario: enumeration(BACKDROPS), titulo: text(90), explicacao: text(340), duracaoMs: numeric(1000, 8000),
  ...
  }, ['titulo', 'explicacao', 'duracaoMs', 'elementos', 'acoes']) }, conclusao: text(280), curiosidade: text(220)
}, ['versao', 'disciplina', 'titulo', 'resumo', 'tipoDeCena', 'cenas', 'conclusao', 'curiosidade']);
